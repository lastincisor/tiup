...
func newDeployCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:        "Deploy a TEM cluster for production",
		Long:         "Deploy a TEM cluster for production. SSH connection will be used to deploy files, as well as creating system users for running the service.",
		SilenceUsage: true,
